...
![页面概览](/open_clife_document/assets/h5tool/3User_guide/1Page_overview/1.png)
...
![控件名修改](/open_clife_document/assets/h5tool/3User_guide/2common_set/CS1.png)
...
默认/选中/禁用的作用是可以让控件有3种显示状态，在不同的状态下可以设置控件的位置、颜色、尺寸等参数，这里需要注意的是，并不是所有的控件都有这三种状态，如列表单选控件就不具备的默认、选中、禁用状态。当控件处于禁用状态时，控件对一些事件无效。
 ![图片](/open_clife_document/assets/h5tool/3User_guide/2common_set/CS2.png)

如：设计一个点击控件时让控件填充颜色为黄色的动作：

1.选中控件，控件的状态设为“选中”状态，勾选填充栏，并将颜色改为黄色后，点击“添加事件”
 ![图片](/open_clife_document/assets/h5tool/3User_guide/2common_set/CS2_1.png)
...
![图片](/open_clife_document/assets/h5tool/3User_guide/2common_set/cs4.png)
...
![图片](/open_clife_document/assets/h5tool/3User_guide/2common_set/cs5.png)

## <b>边框设置</b>

对边框的颜色、边框宽度以及边框的圆角设置，其中宽度和圆角的单位为px（像素），设置圆角参数输入值为圆角半径值，如圆角输入值为50，即控件的圆角半径为50px
![图片](/open_clife_document/assets/h5tool/3User_guide/2common_set/cs6.png)
...
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/1tx.png)

##  <b>滑块控件</b>
滑块控件通过手指按住滑块左右滑动调节参数，可用于调节灯光亮度、音量控制、窗帘开合、摄像头调节焦距等智能场景，在使用时，需要定义好其滑动边界、刻度/样式等
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/2_1hksx.png)
### &ensp;&ensp;1.属性
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/2_2hkys.png)


### &ensp;&ensp;2.样式
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/3_1kgys.png)
...
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/3kg.png)
### &ensp;&ensp;1.属性
...
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/4an.png)
...
### &ensp;&ensp;1.属性
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/5sz.png)



## <b>颜色盘控件</b>
颜色盘控件是一款特殊的通过RGB颜色来传达指令的控件，其基本的原理是将颜色转化为信号的方式下发到设备端，使设备执行根据不同的颜色参数来执行相应的动作，常用于控制灯光颜色，根据不同的应用场景可以选择不同的颜色盘样式。
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/6ys.png)
...
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/6_1yssx.png)


## <b>过程控件</b>

过程控件由多个单过程组合成而成的控件，用于反应事件的进度，可用于网络连接，设备连接等场景，也可以脱离设备作为APP交互进度展示功能，过程控件有16种色调搭配样式，可以根据实际APP风格 选择不同颜色的样式
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/7gc.png)
&ensp;&ensp;<b>填充</b>
...
&ensp;&ensp;<b>控件属性</b>
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/7_1gcys.png)

##   <b>图标单选控件</b>

图标单选控件是一款包含多种模式的单选控件，控件支持模式图标的样式、颜色更换、图标底部的文字设置，控件可以结合设备使用，如，当点击不同的图标就切换到不同的设备场景、读取设备参数，也可以脱离设备用于页面切换
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/8tb.png)
&ensp;&ensp;<b>控件属性</b>
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/8_1tbms.png)
...
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/9rq.png)


### &ensp;&ensp;1.元素容器
元素容器是针对单类元素的容器控件，通过选择不同的模板，可以使得元素有不同的展示方式
&ensp;&ensp;<b>控件属性</b>
 ![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/9_1rqsx.png)
&ensp;&ensp;<b>添加事件</b>
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/9_2sx.png)
...
&ensp;&ensp;<b>控件属性</b>
![图片](/open_clife_document/assets/h5tool/3User_guide/3block_explan/9_3rq.png)
...
### 新增事件
<b>一.新增事件流程：</b>
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/1new/1.png)

<b>二.步骤说明：</b>


步骤1.选中控件，点击【添加事件】
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/1new/2.png)
步骤2：选择事件。在事件名称栏下拉菜单中选择需要的事件名称
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/1new/3.png)
...
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/2type/1.png)


<b>2.协议数据：</b>协议数据是数据关联事件的一类源数据来源，控件通过调用协议，将协议数据映射到控件
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/2type/2.png)
...
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/2type/3.png)
...
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/3act/1.png)

<b>下发指令：</b>下发协议指令，如“灯光控制”协议，包括打开、关闭两个指令，当选择打开参数时，就会下发打开灯光的指令，选择关闭时参数，就会下发关闭灯光的指令，如下图。
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/3act/2xf.png)

<b>页面跳转：</b>事件成立时跳转到其他的界面的动作，跳到的页面为该页面的默认状态。
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/3act/3tz.png)

<b>显示/隐藏：</b> 事件成立时控件执行显示或隐藏的操作，当控件执行隐藏时，在页面不可见
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/3act/4xs.png)

<b>下发控件指令：</b>通过下发控件指令动作可以通过勾选，同时下发多个控件指令的动作，其作用是可以通过一个动作实现让多个控件的指令同时下发，提高交互设计效率，当执行指令下发时忽视下发控件的指令条件
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/3act/5xfkj.png)
...
1.在引用变量界面点击“创建变量
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/3act/6bl.png)
2.点击1步“添加”，添加变量，点击第2步更改变量名，点击“确定”确认增加变量
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/3act/7bl.png)
3.设置变量参数
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/3act/8bl.png)
&ensp;&ensp;3.1.高级设置
在给变量设置参数时，可以点击高级，通过接口返回参数赋值给变量，这样就可以通过变量绑定接口数据参数，方便交互


&ensp;&ensp;&ensp;&ensp;1.点击“高级”，选择插入接口返回数据
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/3act/9gj.png)
&ensp;&ensp;&ensp;&ensp;2.选择对应接口，以及接口参数字段，点击“确认”完成高级设置
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/3act/10gj.png)
...
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/3act/11api.png)

2.输入需要添加的API接口参数，点击【确定】完成创建
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/3act/12api.png)


3.选择对应的接口，输请求body和请求header的参数，点击【确定】，完成API调用
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/3act/13api.png)


&ensp;&ensp;3.1.高级：通过点击“高级”可以在输入框插入变量，这样的好处是方便参数的修改复用和交互，这里需要注意的是支持同时添加多个变量
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/3act/14api.png)


# 事件条件
条件分为条件匹配方式和条件判断两部分，其中条件匹配方式包括满足所有条件和满足任意一个条件；条件判断将源数据与目标数据通过逻辑运算判断条件真假
![图片](/open_clife_document/assets/h5tool/3User_guide/4.event_interanction/4condition/1tj.png)
...
<center class="video-category">
  <a href="https://v.youku.com/v_show/id_XMzg4ODQ3NjkyMA==.html?spm=a2hzp.8244740.0.0">
    <img src="/open_clife_document/assets/h5tool/3User_guide/7video_area/1.png" width="120" height="112" border="0">
  </a>
  <a href="https://v.youku.com/v_show/id_XMzg4ODQ3NDU5Mg==.html?spm=a2hzp.8244740.0.0">
    <img src="/open_clife_document/assets/h5tool/3User_guide/7video_area/2.png" width="120" height="112" border="0">
  </a>
  <a href="https://v.youku.com/v_show/id_XMzg4ODQ3NzYyOA==.html?spm=a2hzp.8244740.0.0">
    <img src="/open_clife_document/assets/h5tool/3User_guide/7video_area/3.png" width="120" height="112" border="0">
  </a>
</center>
...
<center class="video-category">
  <a href="https://v.youku.com/v_show/id_XMzg4ODQ2NDkzMg==.html?spm=a2hzp.8244740.0.0">
    <img src="/open_clife_document/assets/h5tool/3User_guide/7video_area/4.png" width="120" height="112" border="0">
  </a>
  <a href="https://v.youku.com/v_show/id_XMzg4ODQ3NjA2MA==.html?spm=a2hzp.8244740.0.0">
    <img src="/open_clife_document/assets/h5tool/3User_guide/7video_area/5.png" width="120" height="112" border="0">
  </a>
  <a href="https://v.youku.com/v_show/id_XMzg4ODQ3ODQ4OA==.html?spm=a2hzp.8244740.0.0">
    <img src="/open_clife_document/assets/h5tool/3User_guide/7video_area/6.png" width="120" height="112" border="0">
  </a>
</center>
